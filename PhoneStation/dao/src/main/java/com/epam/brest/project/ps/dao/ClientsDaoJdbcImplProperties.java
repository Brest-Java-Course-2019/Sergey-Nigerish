 ...
 */
public class ClientsDaoJdbcImplProperties implements ClientsDao {

    /**
     * Connects logger.
     */
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ClientsDaoJdbcImplProperties.class);
     ...
     */
    public ClientsDaoJdbcImplProperties(
